...
type OpenShiftRequest struct {
	...
	SessionID   string  `json:"session_id"` // Matches the ID generated by UnlockRegister
}
...
func OpenShift(c *gin.Context) {
	...
	newShift := models.ShiftLog{
		...
		Status:          "open",
		OpeningVideoURL: "PENDING_UPLOAD_" + req.SessionID, // Temporarily mark as pending
	}
...
func CloseShift(c *gin.Context) {
	...
	// Expected CASH is strictly: Starting Float + ONLY the Physical Cash they took in.
